...
void FinalApplication::onRun()
{
    ...
    setStats(true);
    addGraph(s::GENERAL, { s::SIMPLE_BACTERIA, s::TWITCHING_BACTERIA, s::SWARM_BACTERIA, s::NUTRIMENT_SOURCES, s::VIRUS}, 0, 150);
...
void FinalApplication::onEvent(sf::Event event, sf::RenderWindow&)
{
    if (event.type == sf::Event::KeyReleased) {
        ...
        case sf::Keyboard::V:
            getEnv().addVirus(new Virus(getCursorPositionInView(), 20));
            break;
